...
test_php() {
 ...
 ./buildconf --force
 fix_configure ./configure
 ./configure --without-pcre-jit --disable-opcache --without-valgrind
...
test_python() {
 ...
 replace_line "#    elif __STDC_VERSION__ >= 201112L && !defined(__STDC_NO_THREADS__)" "#elif 1" Include/pyport.h
 ./configure && make
