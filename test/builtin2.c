...
static_assert(__builtin_offsetof(struct ofs_S1, m[1][2].n.k[3]) == 76,"");
...
static_assert(__builtin_constant_p(1 ? 0 : 0));
int g;
static_assert(!__builtin_constant_p(g));
static_assert(sizeof(__builtin_constant_p(0)) == sizeof(int));
